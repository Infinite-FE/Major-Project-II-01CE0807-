# EfficientNetB0_Train_fixed_resume.py
import os
import torch
...
# Checkpoints folder inside EfficientNetB0
...
def train_model(model, dataloaders, dataset_sizes, criterion, optimizer, num_epochs=10):
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        # Save checkpoint
        checkpoint_path = os.path.join(checkpoint_dir, f"efficientnetb0_epoch_{epoch + 1}.pth")
        torch.save({
            'epoch': epoch,
